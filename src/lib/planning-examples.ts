...
export const PLANNING_EXAMPLE_CATEGORIES: PlanningExampleCategory[] = [
  ...
  // ============================================================
  {
    ...
    examples: [
      ...
      {
        id: "plan-proj-data-platform",
        label: "数据中台建设",
        description: "从零搭建公司数据中台的完整规划",
        category: "project",
        domain: "project",
        timeScale: "months",
        objective: "在8个月内搭建完成公司数据中台，实现数据统一采集、治理、分析和可视化，支撑业务决策",
        context: "公司有6个业务系统（CRM、ERP、OA、电商平台、供应链、财务），数据分散在各个系统中，无法做跨系统分析。老板经常要数据但每次都要IT手动导出拼Excel。公司年营收5亿，数据量中等（日均新增数据约50万条）。IT部门8人，其中2人有大数据经验。预算200万。",
        constraints: "预算有限、团队大数据经验不足、各业务系统数据格式不统一、不能影响现有业务系统运行",
        preferences: "优先打通CRM和电商平台数据，先做营销分析和客户画像两个高价值场景",
      },
    ],
  },
  ...
  // ============================================================
  {
    ...
    examples: [
      ...
      {
        id: "plan-gov-emergency",
        label: "应急预案编制",
        description: "编制城市突发公共事件应急预案",
        category: "government",
        domain: "government",
        timeScale: "months",
        objective: "在3个月内完成全区突发公共事件综合应急预案的编制和桌面推演，通过上级验收",
        context: "某区常住人口120万，有3个大型化工企业、2个地铁在建工程、5个大型商业综合体。去年经历了一次暴雨内涝导致部分地区停电停水的事件，暴露出应急响应机制的不足。区长要求重新编制应急预案，特别是针对自然灾害、安全生产事故、公共卫生事件三类突发事件。区应急管理局有12人，需要协调公安、消防、卫健、交通等8个部门。",
        constraints: "多部门协调困难、部分部门对应急演练不积极、预算只有30万、3个月时间紧张",
        preferences: "重点关注化工安全和暴雨内涝两类高频风险，建立'15分钟应急响应圈'",
      },
    ],
  },
